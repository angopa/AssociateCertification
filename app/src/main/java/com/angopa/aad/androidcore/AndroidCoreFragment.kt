...
import com.angopa.aad.androidcore.codelabs.fundamentals.broadcast.BroadcastReceiverActivity
import com.angopa.aad.androidcore.codelabs.fundamentals.contentproviders.ContentProviderActivity
import com.angopa.aad.androidcore.codelabs.fundamentals.service.ServiceActivity
...
class AndroidCoreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate<FragmentAndroidCoreBinding>(
            inflater,
            R.layout.fragment_android_core, container, false
        ).apply {
